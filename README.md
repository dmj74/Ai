...
اپلیکیشن اندروید هوش مصنوعی با چت متنی، مکالمهٔ صوتی با کارکتر **تیتانالی**، و بخش کامل **آموزش زبان** — متصل به چند سرویس هوش مصنوعی **رایگان**.
...
| بخش | توضیح |
|---|---|
| 💬 **چت** | چت مثل ChatGPT با پاسخ پلکانی (streaming)، تاریخچهٔ گفتگوها (Room)، انتخاب مدل از نوار بالا، کپی متن با نگه‌داشتن انگشت |
...
└── vm/                       # ViewModelها (چت، تیتانالی، آموزش، تنظیمات)
